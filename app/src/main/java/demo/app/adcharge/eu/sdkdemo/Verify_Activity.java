...
public class Verify_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            adcharge = new AdCharge(Constants.URL, Verify_Activity.this, SETTINGS);
        ...
        bt_verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                pDialog = new SweetAlertDialog(Verify_Activity.this, SweetAlertDialog.PROGRESS_TYPE);
                ...
                {
                    Toast.makeText(Verify_Activity.this, "Verified", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Verify_Activity.this, "Invalide Code ,Please try again ", Toast.LENGTH_SHORT).show();
                    pDialog.cancel();
                }
            }
        });
    ...
    public void Verificaton()
    {
        ...
        if (Config.cekKoneksi(Verify_Activity.this)) {
            ...
            Toast.makeText(Verify_Activity.this,"Check your Internet Connection",Toast.LENGTH_LONG).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.DEPRECATED_GET_OR_POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(Verify_Activity.this, response, Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Verify_Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });


        VolleySingleton.getInstance(Verify_Activity.this).addToRequestQueue(stringRequest);
    ...
    public void registration_post(String url) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        pDialog.cancel();
                        //Showing toast
                        Toast.makeText(Verify_Activity.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Verify_Activity.this);
    ...
    private class LoginUserTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... strings) {
            ...
            try {
                adcharge.login(username, password, TRAFFIC_SOURCE_KEY, Verify_Activity.this);
            ...
            if (validationException != null) {
                for (ApiValidationException.Error fieldError : validationException.getFieldErrors()) {
                    ...
                    if ("username".equals(field)) {
                        ...
                        Toast.makeText(Verify_Activity.this,message, Toast.LENGTH_SHORT).show();
                        pDialog.cancel();
    ...
    private class UserSaveTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (validationException != null) {
                ...
                Toast.makeText(getApplicationContext(), "success", Toast.LENGTH_SHORT).show();
                pDialog.dismiss();
                Intent intent=new Intent(Verify_Activity.this,Category_Activity.class);
